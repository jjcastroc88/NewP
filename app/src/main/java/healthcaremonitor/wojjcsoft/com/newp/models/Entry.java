...
public class Entry implements Parcelable {
    ...
    public String getUrlImageEntry(){return urlImageEntry;}

    public void setUrlImageEntry(String urlImageEntry){this.urlImageEntry = urlImageEntry;}
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(urlImageEntry);
        dest.writeString(imName.getLabel());
    }
}
